...
Map.prototype.setSkyProperties = function() {
  ...
  for(var i = 0; i < this.sky_cloud_amount; i++) {
    //var cx = Math.random() < 0.5 ? Math.floor((Math.random() * cameraSettings.renderArea) + 1 ) : Math.floor((Math.random() * cameraSettings.renderArea) + 1 )*-1;
    //var cz = Math.random() < 0.5 ? Math.floor((Math.random() * cameraSettings.renderArea) + 1 ) : Math.floor((Math.random() * cameraSettings.renderArea) + 1 )*-1;
